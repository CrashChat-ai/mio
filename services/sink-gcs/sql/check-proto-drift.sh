...
# the canonical schema (a downstream loader, e.g. a Cloud Run / Airflow
# loader maintained by the deployer) depends on this contract holding. The
# check lives next to the schema, not next to any specific consumer.
#
