...
The `mio-media-vault` sidecar's GCP service account, IAM
...
| Workload-Identity GSA reference in HelmRelease | `fluxcd/apps/prod/mio/release-media-vault.yaml` |
...
flux reconcile helmrelease mio-media-vault -n mio
```
